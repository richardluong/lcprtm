...
sbleu_score_list_file_name = "sBleu.txt"
...
def get_n_best_list_sbleu_score_list_and_total_base_score_list(source_sentence_index, start_line_n_best_list_list):
...
def get_everything(source_sentence_index):
    ...
    n_best_list, total_base_score_list, sbleu_score_list = get_n_best_list_sbleu_score_list_and_total_base_score_list(source_sentence_index, start_line_n_best_list_list)
